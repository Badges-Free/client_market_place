...
function CategoryProducts() {
  ...
  return (
   <>
     <div className="flex flex-col gap-2 w-full mt-5 px-5 pb-2.5 ">
        <h4 className="text-gray-700 capitalize font-[500]">categories product</h4>
        ...
        {data.map((category) => (
          ...
          >
            ...
            <img src={`https://seyhashop.onrender.com/`+category.image} alt="" width="28px"/>
            {category.name}
